    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            // Functions can take parameters such as strings 
            // HelloFriend("Carter");
            // HelloFriend("Madison");
            // HelloFriend("CJ");

            // Functions can take multiple paramters
            // HelloFriends("Carter", "Madison");

            // Functions can have default paramters (default value is none is passed)
            // HelloFriend_s("Carter");
            // HelloFriend_s("Madison", "CJ");

            // Functions can return values. Rather than 'void', the data-type of its return value should take its place
            // int width = 5;
            // int length = 20;
            // int area = find_area(width, length);
            // Console.WriteLine($"The area of a {width}x{length} room is {area}");

            // Functions that have multiple paramters can use a key:value structure to pass parms with no order.
            // String name_1 = "Carter";
            // String name_2 = "Madsion";
            // String name_3 = "CJ";
        ...
        static void HelloFriends(String name_1, String name_2)
        {
            Console.WriteLine($"Hello {name_1} and {name_2}");
        }

        static void HelloFriend_s(String name_1, String name_2 = "")
        {
            if (name_2.Equals(""))
            {
        ...
        static int find_area(int w, int l)
        {
            Console.WriteLine("In int version of 'find_area");
            return w * l;
        }

        // overloaded functions
        static double find_area(double w, double l)
        {
            Console.WriteLine("In double version of 'find_area");
            return w * l;
        }

        static void TheFam(String dad, String mom, String child)
        {
            Console.WriteLine($"{dad}, {mom}, and {child}");
        }
    }
}
